...
if(__name__=="__main__"):
    utils.utils.get_beginning_of_file("ask.wav","beginning_out_test.wav",180)
    ...
    #utils.utils.save_to_file("webrtc_vad.txt", wb.send_to_google_api("ask.wav", "ru_RU", agressivity=1))
